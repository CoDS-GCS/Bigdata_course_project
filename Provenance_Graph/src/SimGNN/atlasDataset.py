...
class ATLASDataset(InMemoryDataset):
    ...
    def raw_file_names(self):
        return ['torch_training_dataset', 'torch_testing_dataset']
    ...
    def process(self):
        data_path_training = "./dataset/atlas/simgnn/hot_encoding/gcn_exp/torch_training_dataset.pt"
        data_list = torch.load(data_path_training)
        torch.save(self.collate(data_list), self.processed_paths[0])
        data_path_testing = "./dataset/atlas/simgnn/hot_encoding/gcn_exp/torch_testing_dataset.pt"        
        data_list = torch.load(data_path_testing)
        torch.save(self.collate(data_list), self.processed_paths[1])
        nged_path = "./dataset/atlas/simgnn/hot_encoding/gcn_exp/nged_matrix.pt"
    ...
    def process_predict_pairs(self,suspSubGraphs,benignSubGraphs,query_graphs):
        ...
        for g in query_graphs:
            ...
            ids += 1
        data_file = "./dataset/atlas/simgnn/hot_encoding/gcn_exp/predict/exp2/query_graphs_dataset.pt"  
        ...
        for host in benignSubGraphs:
            ...
            for g in benignSubGraphs[host]:
                ...
                ids += 1
                host_id+=1
        data_file = "./dataset/atlas/simgnn/hot_encoding/gcn_exp/predict/exp2/predict_dataset.pt"  
        ensure_dir(data_file)
